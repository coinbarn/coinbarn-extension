  ...
  public render() {
    return (
      <div className='welcomeBackScreen'>
        ...
        <button className='hrefBtn' onClick={() => this.props.updateState({screen: 'register', regRecover: false})}>Create New Account</button>
        <button className='hrefBtn' onClick={() => this.props.updateState({screen: 'register', regRecover: true})}>Import Account</button>
      </div>
    );
  }
}
